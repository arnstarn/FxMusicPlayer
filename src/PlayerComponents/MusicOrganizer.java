...
public class MusicOrganizer
{
  ...
  public void loadNewDir(String dir){
    tracks = new ArrayList<Track>();
    player = new MusicPlayer();
    reader = new TrackReader();
    resetTrackIndex();
  ...
  public void playTrack(int index)
  {
    if(indexValid(index)) {
      ...
      System.out.println("curr_index = " + currentTrackIndex + " index_playing = " +  index);
  ...
  public int prevTrackIndex(){
    if (currentTrackIndex == 0){
      currentTrackIndex = getNumberOfTracks()-1;
    } else {
      currentTrackIndex--;
    }
